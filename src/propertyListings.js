...
function PropertyListings() {
  ...
  const propertyListings = [
    ...
    },
    {
      ...
      amenities: ['Free Wi-Fi', 'Hot Tub', 'Mountain Views', 'Fire Pit'],
      description:
        'Escape to this mountain retreat with stunning views. This house features ten bedrooms, a private hot tub, and a cozy fire pit for enjoying the evenings.',
      nearby: ['Hike in the Drakensberg Mountains', 'Explore the Royal Natal National Park', 'Stargazing at night'],
    },
