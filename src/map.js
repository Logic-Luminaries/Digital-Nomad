...
function CreateMarker(positions, map) {
  positions.forEach((item) => {
    ...
    //The popup window for the extra information about the building markers
    const infowindow = new window.google.maps.InfoWindow({
      content: `
        <div class="info-window">
          ...
          <button onclick="window.location='/propertyListings?id=${item.id}'">Book</button>
        </div>
      `,
    });
